...
public class IndieAnalytics : MonoBehaviour
{
    ...
    public static IndieAnalytics GetObject()
    {
        GameObject ia_object = GameObject.Find("IndieAnalytics");
        ...
        return ia_object.GetComponent<IndieAnalytics>();
    }
    ...
    public void SendEvent(string event_type, Object custom_event_data = null)
    {
        if (!initialized)
        {
            Debug.LogWarning(String.Format("Cant send event {0}, not initialized yet"));
            return;
        }
